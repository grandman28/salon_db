...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $promotii = $_POST['promotii']? $_POST['promotii'] : "Nu";
    $sex = $_POST['sex'] ? $_POST['sex'] : null;

    if (!empty($nume) && !empty($prenume) && !empty($telefon) && !empty($promotii)) {
        $sql = "INSERT INTO Clienti (Nume, Prenume, Telefon, Email, DataNasterii, 
        Strada, Numar, Bloc, Localitate, Judet, Promotii, Sex) VALUES (?,?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        $params = [$nume, $prenume, $telefon, $email, $dataNasterii, $strada, $numar, $bloc, $localitate, $judet, $promotii, $sex];
        ...
        if ($stmt === false) {
            ...
            $_SESSION['message'] = "Clientul a fost adăugat cu succes!";
                ...
                <main role="main" class="col-md-12 px-4">
                    <div class="container" style="margin-top: 20px;">
                        ...
                        <form method="POST">
                            ...
                            <div class="row mb-2 mt-4">
                                <label for="dataNasterii" class="col-sm-2 col-form-label">Data Nasterii:</label>
                                ...
                                <div class="col-sm-1">
                                <input type="checkbox" id="promotii" name="promotii" value="Da" checked>
                                </div>
                            </div>
                            <div class="row mb-2 mt-4">
                            ...
                            <div class="row mb-2 mt-4">
                                ...
                                <div class="col-sm-1">
                                    <a href="/bd/dashboard/clienti.php" class="btn btn-secondary">Înapoi</a>
                                </div>
                                <div class="col-sm-1">
